<li>
    <article 
        tabindex="0" 
        class="cursor-pointer border rounded-md p-3 bg-white flex text-gray-700 mb-0 hover:border-green-500 focus:outline-none focus:border-green-500"
        onclick="updateNav('{{ $proyecto->nombre }}', '{{ addslashes($proyecto->descripcion) }}')"
    >
